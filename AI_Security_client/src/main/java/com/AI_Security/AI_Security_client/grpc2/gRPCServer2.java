...
public class gRPCServer2 {
    ...
    public void setPolymerizationUserService(PolymerizationUserService polymerizationUserService) {
        gRPCServer2.polymerizationUserService = polymerizationUserService;
    }

    private static final Logger log = LoggerFactory.getLogger(gRPCServer2.class);
    ...
    public gRPCServer2(String host, int port) {
